...
(function($) {
    ...
    "plugins": {
        "audio": {
            "url": "http%3A//mightymonsters.de/%2B%2Bresource%2B%2Bcollective.flowplayer/flowplayer.audio.swf"
        }, 
        "controls": {
            "url": "http%3A//mightymonsters.de/%2B%2Bresource%2B%2Bcollective.flowplayer/flowplayer.controls.swf", 
            "volume": true
        }
    }, 
    "usePlayOverlay": true, 
    "autoPlay": false
                ...
                flowplayer(this, {"src": "http://mightymonsters.de/++resource++collective.flowplayer/flowplayer.swf"}, config).onLoad( function() { this.setVolume(50); });
    ...
    "autoPlay": false
                ...
                flowplayer(this, {"src": "http://mightymonsters.de/++resource++collective.flowplayer/flowplayer.swf"}, config).playlist(playlist_selector, {loop: true, manual: true}).onLoad( function() { this.setVolume(50); });
                $self.show();
                $('.flowPlayerMessage').remove();
